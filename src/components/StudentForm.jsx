...
const StudentForm = () => {
  ...
  const fetchClubOptions = async () => {
    try {
      const response = await axios.get('https://club-backend-tau.vercel.app/api/GetClubs');
  ...
  const fetchStudentDetails = async () => {
    try {
      ...
      const response = await axios.get(
        `https://club-backend-tau.vercel.app/api/student/${userId}`
      );
  ...
  const onSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://club-backend-tau.vercel.app/api/studentForm', {
