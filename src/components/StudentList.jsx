...
const StudentList = () => {
  ...
  useEffect(() => {
    const fetchStudents = async () => {
      try {
        const response = await axios.get('https://club-backend-tau.vercel.app/api/StudentForm');
  ...
  const handleDelete = async (id) => {
    try {
      await axios.delete(`https://club-backend-tau.vercel.app/api/deleteStudent/${id}`);
  ...
  const handleAccept = async (id) => {
    try {
        await axios.post(`https://club-backend-tau.vercel.app/api/AcceptStudent/${id}`);
