...
const ClubMembers = () => {
  ...
  const fetchClubMembers = async () => {
    try {
      const response = await axios.get('https://club-backend-tau.vercel.app/api/GetClubMembers');
  ...
  const handleDeleteMember = async (clubName, memberId) => {
    try {
      await axios.delete(`https://club-backend-tau.vercel.app/api/deleteClubMember/${clubName}/${memberId}`);
